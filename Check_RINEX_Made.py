#-------------------------------------------------------------------------------
# Name:        Check_RINEX_Made
# Purpose:     Sometimes Hemisphere GNSS software does not convert the binary files to RINEX
#              files. This code is to check if files have been converted to RINEX. If they have
#              not call the RINEX conversions in cmd. Run through windows schedular. 
#
# Author:      GPSMET1
#
# Created:     04/11/2014
