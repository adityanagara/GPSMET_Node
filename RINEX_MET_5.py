#-------------------------------------------------------------------------------
# Name:        RINEX_Met
# Purpose:     Take serial data from Vaisala WXT-510 Weather station and Paroscientific
#              Barometer and put them onto RINEX files. Script runs on windows schedular
#              set for 5 minutes every day. Temp(C), Relative humidity(%) [WXT-510] 
#              pressure (hPa) [Paros 6000-16B]
# Author:      Aditya
#
# Created:     31/07/2014
